...
export const siteContent: SiteContent = {
  hero: {
    ...
    subtitle:
      "A scrollable story of how we built the Extranet with AI — where it moved fast, where it broke down, and what changed in our workflow.",
    ctas: [
  ...
  learnings: [
    ...
    },
    {
      ...
      paragraph:
        "Building a full feature in one prompt rarely works. The output looks complete but important pieces are missing, inconsistent, or untested. The better approach is to break the feature into clear modules — data structure, default screen, actions and flows, edge cases — and build one chunk at a time. Each chunk gets its own prompt, its own validation, and only connects to the next once it's working correctly. It takes more steps but produces something you can actually trust.",
      insight:
        "Break your feature into chunks before prompting. Build one, validate it, then move to the next.",
      layout: "interactive-quiz",
      gameType: "rank-order",
